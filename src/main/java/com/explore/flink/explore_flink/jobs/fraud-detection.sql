-- =====================================================
-- E-Commerce Fraud Detection - Flink SQL Job
-- =====================================================

SET 'execution.checkpointing.interval' = '60s';
SET 'execution.checkpointing.mode' = 'EXACTLY_ONCE';
SET 'table.exec.state.ttl' = '86400000';
SET 'pipeline.name' = 'ecommerce-fraud-detection';

-- =====================================================
-- SOURCE TABLES
-- =====================================================

-- Orders stream from Kafka
CREATE TABLE orders (
  order_id STRING,
  customer_id STRING,
  product_id STRING,
...
-- Enriched orders to Kafka
CREATE TABLE enriched_orders_kafka (
  order_id STRING,
  customer_id STRING,
  customer_name STRING,
...
-- Fraud alerts to PostgreSQL (for persistence)
CREATE TABLE fraud_alerts_db (
  alert_id STRING,
  alert_type STRING,
  order_id STRING,
  customer_id STRING,
...
-- Real-time metrics to PostgreSQL
CREATE TABLE order_metrics_db (
